#
#  Be sure to run `pod spec lint TapErrorReportingV2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Tap error reporting library.Tap error reporting library."

  spec.homepage     = "https://github.com/Tap-Payments/TapErrorReportingV2"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapErrorReportingV2.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapErrorReportingV2/TapErrorReportingV2/Source/**/*.{h,m,swift}"
  ...
  spec.dependency "TapAlertViewControllerV2"
  spec.dependency "TapApplicationV2"
  spec.dependency "TapBundleLocalizationV2"
  spec.dependency "TapNetworkManagerV2"
end
